...
{/*     <ul className="flex flex-col p-4 mt-4 border md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 dark:text-black text-black">
                    ...
                    <li>
                        <a href="#" className="block py-2 pl-3 pr-4  rounded md:p-0 dark:hover:text-white">Quienes somos</a>
                    </li>
                    <li>
                        <a href="#" className="block py-2 pl-3 pr-4 md:p-0 dark:hover:text-white">Contact</a>
                    </li>
                    </ul>
                </div> */}